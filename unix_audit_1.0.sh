...
PROCESS_PROC "lshw" "Hardware Info"
PROCESS_PROC "lsblk" "Block devices Info"
PROCESS_PROC "lsusb -v" "USB Info"
PROCESS_PROC "lspci -v" "PCI Info"
...
PROCESS_FILE $(ls -l /etc/sssd/sssd.conf | awk '{print$NF}') "SSSD Automounter config #1"
PROCESS_FILE $(ls -l /etc/sssd.conf | awk '{print$NF}') "SSSD Automounter config #2"
...
PROCESS_COM "/usr/bin/oslevel -r" "AIX highest recommended maintenance level #1"
PROCESS_COM "/usr/bin/oslevel -s" "AIX highest recommended maintenance level #2"
